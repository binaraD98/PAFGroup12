...
public class ProductService {
	...
	public String insertProduct(@FormParam("productCode") String productCode, 
	 ...
	 @FormParam("productInventor") String productInventor, 
	 @FormParam("productType") String productType) 
	{ 
	 String output = productObj.insertProduct(productCode,productName,productPrice,productInventor,productType); 
	return output; 
	}
	...
	//Read the values from the JSON object
	 ...
	 String productInventor = productObject.get("productInventor").getAsString(); 
	 String productType = productObject.get("productType").getAsString(); 
	 String output = productObj.updateProduct(productID,productCode,productName,productPrice,productInventor,productType); 
	return output; 
	}
